      ...
      <div className="canvas-container">
        {viewMode === 'draft' && (
          <>
            ...
            {/* Legend */}
            <div 
              className={`draft-legend draggable-panel ${legendMinimized ? 'minimized' : ''} ${draggingPanel === 'legend' ? 'dragging' : ''}`}
              style={{ left: legendPos.x, top: legendPos.y, right: 'auto' }}
              onMouseDown={(e) => handlePanelMouseDown(e, 'legend')}
            ...
            {/* Level Info */}
            <div 
              className={`level-info-panel draggable-panel ${infoMinimized ? 'minimized' : ''} ${draggingPanel === 'info' ? 'dragging' : ''}`}
              style={infoPos.x !== null ? { left: infoPos.x, top: infoPos.y, right: 'auto' } : {}}
              onMouseDown={(e) => handlePanelMouseDown(e, 'info')}
              onMouseMove={handlePanelMouseMove}
              onMouseUp={handlePanelMouseUp}
              onMouseLeave={handlePanelMouseUp}
            >
              <div className="panel-header">
                ...
                <button 
                  ...
                  title={infoMinimized ? 'Expand' : 'Minimize'}
                >
                  {infoMinimized ? '▶' : '▼'}
                </button>
              </div>
